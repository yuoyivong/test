...
export const CodeBlock2 = createReactBlockSpec(
    ...
    },
    {
        render: ({ block, editor }) => {
            ...
            const [mode, setMode] = useState(block.props.language ? block.props.language : 'javascript');

            const handleLanguageChange = (data) => setMode(data);
            ...
            return (
                <div style={{ position: "relative" }} className="code-ooo w-full focus-visible:outline-none outline-none">
                    <button
