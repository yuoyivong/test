...
export const CodeBlock2 = createReactBlockSpec(
  {
    type: TYPE,
    propSchema: {
      data: {
  ...
  },
  {
    render: ({ block, editor }) => {
      ...
      return (
        <div className="relative code-ooo w-full focus-visible:outline-none outline-none">
          <button
          ...
          {/* <Select
            ...
            className="absolute top-8 left-2 text-xs z-50"
          >
          ...
          <select
            ...
            className="absolute top-8 left-2 text-xs w-32 rounded-lg h-6"
          >
            <option value="p-5" disabled>
              Select language
            </option>
            <option className="px-6 py-2" value="javascript">
              JavaScript
            </option>
