                ...
                <DialogContent className="max-w-screen !w-[320px] !h-[400px] !rounded-3xl">
                    <DialogHeader className="flex flex-col justify-between">
                        <DialogDescription className="flex flex-col justify-between mx-auto text-center space-y-8">
                            <div className="">
                                <Image src={logout} width={150} height={150} alt={'logo'} className="mx-auto" />
                            </div>
                            ...
                            <div className="flex gap-4 w-full">
                                ...
                                <p onClick={() => signOut({callbackUrl: "/"})} className="cursor-pointer w-1/2 h-[44px] bg-blackUi text-white mt-6 text-xs xl:text-base rounded-xl border border-blackUi hover:bg-blackUi hover:text-white flex justify-center items-center">
                                    Yes
                                </p>
                            </div>
                        </DialogDescription>
