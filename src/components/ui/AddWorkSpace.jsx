                        ...
                        <DialogDescription>
                            <div className="space-y-5">
                                <Input
                                    ...
                                    className={`rounded-lg xl:rounded-radiusBorder h-12 text-xs sm:text-sm xl:text-base font-normal bg-primaryCherUi text-blackUi focus-visible:ring-0 ${error ? "border-red-500" : ""
                                    }`}
                                />
                                {error && (
