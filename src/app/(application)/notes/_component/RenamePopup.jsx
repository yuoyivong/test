...
const RenamePopup = ({ workspaceName, onClose }) => {
    const [name, setName] = useState(workspaceName);
    const [error, setError] = useState("");

    // Effect to update name when workspaceName prop changes
    useEffect(() => {
                    ...
                    <DialogDescription>
                        <div className="space-y-5">
                            <Input
                                ...
                                className={`rounded-lg xl:rounded-radiusBorder h-12 text-xs sm:text-sm xl:text-base font-medium bg-primaryCherUi text-blackUi focus-visible:ring-0  
                            ...
                            <div className="flex gap-1 items-center justify-start">
                                ...
                                <p className="text-lessBlackUi text-xs sm:text-sm xl:text-base text-start">
                            ...
                            <div className="w-full flex justify-end">
                                <Button
                                    className="bg-blackUi text-white mt-6 text-xs sm:text-sm xl:text-base rounded-lg xl:rounded-radiusBorder xl:w-32 xl:h-11 hover:bg-blackUi hover:text-white"
                                    variant="outline"
