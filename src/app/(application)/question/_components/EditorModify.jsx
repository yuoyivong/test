...
const EditorModify = ({ data, writable, handleSaveData }) => {
    ...
    return (
        <>
            <BlockNoteView onChange={(e) => handleChange(e)} data-changing-font-demo className="w-full min-h-64 xl:min-h-96 !p-0" editor={editor} editable={writable} theme={'light'} slashMenu={false} sideMenu={false}>
                <SideMenuController
                    sideMenu={(props) => (
                        <SideMenu
                            {...props}
